...
myDmenu    = "dmenu_run -fn 'JetBrains Mono-11' -nb '#1d1f21' -nf '#c5c8c6' -sb '#c5c8c6' -sf '#1d1f21'"
...
myStartupHook = do
    spawnOnce "feh --bg-scale /home/chuy/Pictures/wallpapers/daft_punk_1.png &"
    spawnOnce "compton &"
    -- spawnOnce "polkit-gnome &"
...
main = do 
    ...
    xmonad $ docks def {
        ...
        logHook            = myLogHook <+> dynamicLogWithPP xmobarPP
            ...
            , ppVisible = xmobarColor "#8abeb7" ""
            , ppHidden = xmobarColor "#8abeb7" "" . wrap "*" ""
            , ppHiddenNoWindows = xmobarColor "#8abeb7" ""
