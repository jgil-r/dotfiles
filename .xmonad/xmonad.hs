...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Launch Spotify
    , ((modm, xK_s), spawn "flatpak run com.spotify.Client")

    -- Launch Discord
    , ((modm, xK_d), spawn "flatpak run com.discordapp.Discord")
...
myLayout = avoidStruts $ mySpacing 5 (tiled ||| Mirror tiled ||| Full)
  where
...
myStartupHook = do
    spawnOnce "feh --bg-scale /home/chuy/Pictures/wallpapers/dark_mountain.png &"
    spawnOnce "compton &"
...
main = do 
    xmproc <- spawnPipe "xmobar -x 0 /home/chuy/.config/xmobar/xmobar.config"
    xmonad $ docks def {
        -- simple stuff
        terminal           = myTerminal,
        ...
        logHook            = myLogHook <+> dynamicLogWithPP xmobarPP
                                ...
                                , ppHidden = xmobarColor "#c5c8c6" "" . wrap "*" ""
